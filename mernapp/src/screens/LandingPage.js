...
import Covervid from "../content/videos/LandingBG.mp4";
      ...
      <div className="LandingPageBody">
        <div>
          <header class="LandingHeader">
            ...
            <div className="container h-100 content-div">
              <div className="d-flex h-100 text-center align-items-center">
                <div className="w-100 text-white">
                  <h1 className="display-3 vid-heading">GAME BAAZI</h1>
                  <p className="lead mb-0 vid-para">
                    Pakistan's Largest Video Game Store
                  </p>
                  <div className="buttons LandingButton">
                    <Link
                      to="/signup"
                      className="btn btn-primary custom-btn1 LandingButtonSub"
                    >
                      Sign Up
                    </Link>
                    <Link
                      to="/clientsignin"
                      className="btn btn-secondary custom-btn1 LandingButtonSubs"
                    >
                      Sign In
                    </Link>
                  </div>
          ...
          <div className="container">
            <div className="row">
              <div className="col-md-8 mx-auto text-center">
                ...
                <p className="lead">
                  We are an online video game store based in Pakistan. In this
                  era of digitalized gaming, we aim to provide gamers with a
                  seamless and enjoyable experience. Our mission is to offer a
                  wide range of video games, accessories, and services, catering
                  to the diverse needs of gamers across the country. We are
                  committed to delivering exceptional customer service, ensuring
                  that every gamer finds what they need to enhance their gaming
                  journey.
                </p>
              </div>
            </div>
          ...
          <div className="row row-cols-1 row-cols-md-3 g-4">
            <div className="col">
              <div className="card h-100 custom-card">
                <img
                  src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQG456OyyPRupId_zJvONMCN5VlG3JydwLHdFit-BSjEw&s"
                ...
                <div className="card-body">
                  ...
                  <p className="card-text">
                    Experience lightning-fast loading with an ultra-high-speed
                    SSD, deeper immersion with support for haptic feedback,
                    adaptive triggers, and 3D Audio.
                  </p>
                  <Link
                    to="/clientsignin"
                    className="btn btn-primary custom-btn btn-card"
                  >
                    View Marketplace
                  </Link>
                </div>
            ...
            <div className="col">
              <div className="card h-100 custom-card">
                <img
                  src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQXkU7S9Ek9tVtLPnZ2HkqhnkQULb2d0jjpzA-2Jnp_Bw&s"
                  className="card-img-top"
                  alt="Video Game"
                />
                <div className="card-body">
                  ...
                  <p className="card-text">
                    Join the criminal underworld in the award-winning
            ...
            <div className="col">
              <div className="card h-100 custom-card">
                <img
                  src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTuu_antBQsR6VC6vxtYFOBvGd4Cx5kC3CZiAoa3kF1lA&s"
                  className="card-img-top"
                  alt="Game Pass Subscription"
                />
                <div className="card-body">
                  <h5 className="card-title">Game Pass Subscription</h5>
                  <p className="card-text">
                    Access a library of over 100 high-quality games, with new
                    games added all the time. Enjoy exclusive member discounts
                    and deals.
                  </p>
                  <Link
                    to="/clientsignin"
            ...
            <div className="col">
              <div className="card h-100 custom-card">
                <img
                  src="https://i.ytimg.com/vi/VFTsbpCKgXA/maxresdefault.jpg"
                  className="card-img-top"
                  alt="Headphones"
                />
                <div className="card-body">
                  ...
                  <p className="card-text">
                    Immerse yourself in high-quality audio with these premium
                    headphones.
                  </p>
                  <Link
                    to="/clientsignin"
            ...
            <div className="col">
              <div className="card h-100 custom-card">
                <img
                  src="https://imageio.forbes.com/specials-images/imageserve/5e4094c7f133f400076c0514/Xbox-One-vs-PS5/960x0.jpg?format=jpg&width=960"
                  className="card-img-top"
                  alt="Xbox Series X"
                />
                <div className="card-body">
                  ...
                  <p className="card-text">
                    Experience next-gen gaming with the Xbox Series X console.
                  </p>
                  <Link
                    to="/clientsignin"
                    className="btn btn-primary custom-btn btn-card"
            ...
            <div className="col">
              <div className="card h-100 custom-card">
                <img
                  src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTT6zY9ew2HAmKSu7DfW8serCB_Q66NIkoKi6yBrovzIQ&s"
                  className="card-img-top"
                  alt="FIFA 23"
                />
                <div className="card-body">
                  ...
                  <p className="card-text">
                    Play the latest installment of the FIFA series and
                    experience realistic football action.
                  </p>
                  <Link
                    to="/clientsignin"
                    className="btn btn-primary custom-btn btn-card"
        ...
        <section className="py-3 py-md-5 py-xl-8 testimonial">
          <div className="container">
            <div className="row justify-content-md-center">
              <div className="col-12 col-md-10 col-lg-8 col-xl-7 col-xxl-6">
                <h2 className="mb-4 display-5 text-center">Testimonials</h2>
                <p className="text-center mb-5 text-center fs-4 custom">
                  Check out what our customers have to say about their
                  experience!
                </p>
                <hr className="w-50 mx-auto mb-5 mb-xl-9 border-dark-subtle" />
              </div>
            ...
            <div className="row justify-content-lg-around gy-5 gy-md-6">
              <div className="col-12 col-sm-6 col-lg-5">
                <div className="col-xl-11 col-xxl-10 mx-auto text-center">
                  ...
                  />
                  <p className="mb-2">
                    "I've always found the latest games I wanted here. Great
                    service and quick delivery!"
                  </p>
                  <p className="m-0 fw-bold">Sam Green - Gamer</p>
                </div>
              </div>
              <div className="col-12 col-sm-6 col-lg-5">
                <div className="col-xl-11 col-xxl-10 mx-auto text-center">
                  ...
                  />
                  <p className="mb-2">
                    "The selection of games is amazing, and the prices are
                    unbeatable!"
                  </p>
                  <p className="m-0 fw-bold">Alex Turner - Game Enthusiast</p>
                </div>
              </div>
              <div className="col-12 col-sm-6 col-lg-5">
                <div className="col-xl-11 col-xxl-10 mx-auto text-center">
                  ...
                  />
                  <p className="mb-2">
                    "I've been a customer for years. Always satisfied with the
                    service and quality of products."
                  </p>
                  <p className="m-0 fw-bold">Ryan Scott - Gaming Fanatic</p>
                </div>
              </div>
              <div className="col-12 col-sm-6 col-lg-5">
                <div className="col-xl-11 col-xxl-10 mx-auto text-center">
                  ...
                  />
                  <p className="mb-2">
                    "This store never disappoints. Whether it's a new release or
                    an old classic, they have it all!"
                  </p>
                  <p className="m-0 fw-bold">Emily Johnson - Hardcore Gamer</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="container">
              <div className="row">
                <div className="col-xs-12 col-sm-6 col-md-3">
                  <div className="widget subscribe no-box">
                    <h5 className="widget-title">
                      GAME BAAZI<span></span>
                    </h5>
                    <p>Pakistan's Leading Video Game Store ..</p>
                  </div>
                </div>
                    ...
                    <ul className="thumbnail-widget">
                      <li>
                        <div className="thumb-content">
                          <Link className="link-style-main1" to="/signup">
                            Get Started
                          </Link>
                        </div>
                      </li>
                      <li>
                        <div className="thumb-content">
                          <Link className="link-style-main1" to="/clientsignin">
                            Get Back
                          </Link>
                        </div>
                      </li>
                ...
                <div className="col-xs-12 col-sm-6 col-md-3">
                  <div className="widget no-box">
                    <h5 className="widget-title">
                      Admin Side<span></span>
                    </h5>
                    <p>Admin's Dashboard (only for authorized personal)'.</p>
                    <Link className="link-style-main1" to="/adminsignin">
                      {" "}
                      Sign In{" "}
                    </Link>
                  </div>
                ...
                <div className="col-xs-12 col-sm-6 col-md-3">
                  <div className="widget no-box">
                    ...
                    <p>
                      <a
                        href="mailto:hammadmalikdx@gmail.com"
                        title="glorythemes"
                      >
                        GameBaazi@hotmail.com
                      </a>
                    </p>
            ...
            <div className="container">
              <div className="row">
                <div className="col-md-12 text-center">
                  <p>Copyright GameBaazi © 2024. All rights reserved.</p>
                </div>
              </div>
            </div>
          </div>
